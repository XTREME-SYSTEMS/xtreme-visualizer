...
export default function Settings() {
  ...
  return (
    <div className="space-y-5">
      ...
      <SectionCard index="05" title="Standard pricing" tag="Your rates">
      ...
      <SectionCard index="06" title="Cost of doing business" tag="Overhead">
      ...
      <SectionCard index="07" title="Account management" tag="Danger zone">
