...
app.addEventListener('click',async event=>{
 ...
 try{
  ...
  if(command==='export-data')download(JSON.stringify(state,null,2),'visual-x-runtime.json','application/json');
