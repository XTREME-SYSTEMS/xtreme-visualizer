...
function leadPage(){
 ...
 return `<section class="vx-page vx-page-scroll" data-route="lead">
  ...
  <section class="vx-card ai-card"><div class="ai-score">${lead?'82':'--'}</div><div><span class="vx-kicker">XTREME AI</span><h3>${lead?'Next Best Action':'Awaiting verified lead'}</h3><p>${lead?'Prepare a manual visualization and internal estimate.':'No recommendation is generated without operator-entered lead data.'}</p></div><button class="vx-btn outline-accent compact" ${lead?'':'disabled'} data-nav="blends">View Suggestion</button></section>
