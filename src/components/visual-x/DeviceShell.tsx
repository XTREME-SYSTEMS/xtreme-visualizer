          ...
          {isDesktop ? (
            <>
              <aside className="vx-sidebar">
                <img src="/logo.png" alt="Xtreme Floor Visualizer" style={{ height: 34, width: 'auto', objectFit: 'contain', filter: 'drop-shadow(0 0 10px rgba(240,244,11,.25))', marginTop: 8, marginLeft: -12 }} />
            ...
            <>
              ...
              <div className="vx-brandbar">
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  {showBack && <button onClick={goBack} className="vx-back-btn" aria-label="Go back"><ChevronLeft className="vx-icon" /></button>}
                  <img src="/logo.png" alt="Xtreme Floor Visualizer" style={{ height: 120, width: 'auto', objectFit: 'contain', filter: 'drop-shadow(0 0 10px rgba(240,244,11,.25))', marginTop: 8, marginLeft: -12 }} />
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  <RemindersBell />
