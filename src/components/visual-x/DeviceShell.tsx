          ...
          {isDesktop ? (
            <>
              <aside className="vx-sidebar">
                <img src="https://media.base44.com/images/public/6a72dc735df4ab468b4b1441/75f172e46_LOGO.png" alt="Xtreme Floor Visualizer" style={{ height: 17, width: 'auto', objectFit: 'contain', filter: 'drop-shadow(0 0 10px rgba(253,184,19,.25))', marginTop: 8, marginLeft: -12 }} />
            ...
            <>
              ...
              <div className="vx-brandbar">
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  {showBack && <button onClick={goBack} className="vx-back-btn" aria-label="Go back"><ChevronLeft className="vx-icon" /></button>}
                  <img src="https://media.base44.com/images/public/6a72dc735df4ab468b4b1441/75f172e46_LOGO.png" alt="Xtreme Floor Visualizer" style={{ height: 60, width: 'auto', objectFit: 'contain', filter: 'drop-shadow(0 0 10px rgba(253,184,19,.25))', marginTop: 8, marginLeft: -12 }} />
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  <RemindersBell />
