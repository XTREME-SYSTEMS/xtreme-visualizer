          ...
          {isDesktop ? (
            <>
              <aside className="vx-sidebar">
                <img src="/logo.png" alt="Xtreme Floor Visualizer" style={{ height: 34, width: 'auto', objectFit: 'contain', filter: 'drop-shadow(0 0 10px rgba(255,214,10,.25))', marginTop: 4, marginLeft: -4 }} />
            ...
            <>
              ...
              <div className="vx-brandbar">
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  {showBack && <button onClick={() => navigate(-1)} className="vx-back-btn" aria-label="Go back"><ChevronLeft className="vx-icon" /></button>}
                  <img src="/logo.png" alt="Xtreme Floor Visualizer" style={{ height: 120, width: 'auto', objectFit: 'contain', filter: 'drop-shadow(0 0 10px rgba(255,214,10,.25))', marginTop: 4, marginLeft: -4 }} />
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  <RemindersBell />
